...
;;Based on: https://github.com/kevrgithub/autohotkey/blob/master/Lib/Memory.ahk (converted to AHK_V2)
...
Memory_GetProcessHandle(process_id) {
    return DllCall("OpenProcess", "UInt", 0x001F0FFF, "Int", false, "UInt", process_id, "Ptr")
}
